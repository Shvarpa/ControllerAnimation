export default {
    buttons: {
        "A": { x:0.765, y:0.4206, color: "rgb(123,187,100)" },
        "B": { x:0.8355, y:0.3157, color: "rgb(213,51,62)" },
        "X": { x:0.6945, y:0.3157, color: "rgb(32,146,242)" },
        "Y": { x:0.765, y:0.21, color: "rgb(234,229,3)" },
        ...
        "GUIDE": { x: 0.4995, y: 0.159, size: 0.05 },
    },
    axis: {
        "L": { x: 0.228, y: 0.3175 },
        "R": { x: 0.633, y: 0.549 },
